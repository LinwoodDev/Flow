                    ...
                    children: [
                      _AssignedObjectField(
                          ...
                          onChanged: (value) => assigned = assigned.copyWith(
                              everyone: value, removeEveryone: value == null)),
                      const Divider(),
                      Expanded(
                          child: TabBarView(
                              controller: _tabController,
                                                              ...
                                                              .map((e) =>
                                                                  SimpleDialogOption(
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        setState(() =>
                                                                            assigned =
                                                                                assigned.copyWith(users: List.from(assigned.users)..add(AssignedObject(flag: true, id: e.id))));
                                                                      }))
                                                              .toList())),
                                              icon: const Icon(
                                                              ...
                                                              .map((e) =>
                                                                  SimpleDialogOption(
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        setState(() =>
                                                                            assigned =
                                                                                assigned.copyWith(teams: List.from(assigned.teams)..add(AssignedObject(flag: true, id: e.id))));
                                                                      }))
                                                              .toList())),
                                              icon: const Icon(
                                                  PhosphorIcons.plusLight),
