...
class SourcedPagingSuccessMapper extends ClassMapperBase<SourcedPagingSuccess> {
  ...
  static const Field<
    ...
    List<List<ConnectedModel<String, dynamic>>>
  >
  _f$dates = Field('dates', _$dates, opt: true, def: const [], arg: _arg$dates);
  ...
  static const Field<SourcedPagingSuccess, bool> _f$hasReachedMax = Field(
    'hasReachedMax',
    _$hasReachedMax,
    opt: true,
    def: false,
  ...
  static const Field<SourcedPagingSuccess, int> _f$currentDate = Field(
    'currentDate',
    _$currentDate,
    opt: true,
    def: 0,
...
mixin SourcedPagingSuccessMappable<T> {
  ...
  >
  get copyWith =>
      _SourcedPagingSuccessCopyWithImpl<
        SourcedPagingSuccess<T>,
        SourcedPagingSuccess<T>,
        T
      >(this as SourcedPagingSuccess<T>, $identity, $identity);
  @override
  String toString() {
    return SourcedPagingSuccessMapper.ensureInitialized().stringifyValue(
      this as SourcedPagingSuccess<T>,
    );
  }

  @override
  bool operator ==(Object other) {
    return SourcedPagingSuccessMapper.ensureInitialized().equalsValue(
      this as SourcedPagingSuccess<T>,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SourcedPagingSuccessMapper.ensureInitialized().hashValue(
      this as SourcedPagingSuccess<T>,
    );
  }
}
...
extension SourcedPagingSuccessValueCopy<$R, $Out, T>
  ...
  get $asSourcedPagingSuccess => $base.as(
    (v, t, t2) => _SourcedPagingSuccessCopyWithImpl<$R, $Out, T>(v, t, t2),
  );
}
