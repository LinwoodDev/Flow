...
class CalendarFilterMapper extends ClassMapperBase<CalendarFilter> {
  ...
  static const Field<CalendarFilter, List<EventStatus>> _f$hiddenStatuses =
      Field(
        ...
        _$hiddenStatuses,
        opt: true,
        def: const [EventStatus.draft, EventStatus.cancelled],
      );
  static String? _$source(CalendarFilter v) => v.source;
  static const Field<CalendarFilter, String> _f$source = Field(
    'source',
    _$source,
    opt: true,
  );
  static Uint8List? _$group(CalendarFilter v) => v.group;
  static const Field<CalendarFilter, Uint8List> _f$group = Field(
    'group',
    _$group,
    opt: true,
  );
  static Uint8List? _$event(CalendarFilter v) => v.event;
  static const Field<CalendarFilter, Uint8List> _f$event = Field(
    'event',
    _$event,
    opt: true,
  );
  static bool _$past(CalendarFilter v) => v.past;
  static const Field<CalendarFilter, bool> _f$past = Field(
    'past',
    _$past,
    opt: true,
    def: false,
  ...
  static const Field<CalendarFilter, Uint8List> _f$resource = Field(
    'resource',
    _$resource,
    opt: true,
  );
...
mixin CalendarFilterMappable {
  String toJson() {
    return CalendarFilterMapper.ensureInitialized().encodeJson<CalendarFilter>(
      this as CalendarFilter,
    );
  }

  Map<String, dynamic> toMap() {
    return CalendarFilterMapper.ensureInitialized().encodeMap<CalendarFilter>(
      this as CalendarFilter,
    );
  }

  CalendarFilterCopyWith<CalendarFilter, CalendarFilter, CalendarFilter>
  get copyWith => _CalendarFilterCopyWithImpl<CalendarFilter, CalendarFilter>(
    this as CalendarFilter,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return CalendarFilterMapper.ensureInitialized().stringifyValue(
      this as CalendarFilter,
    );
  }
  ...
  bool operator ==(Object other) {
    return CalendarFilterMapper.ensureInitialized().equalsValue(
      this as CalendarFilter,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return CalendarFilterMapper.ensureInitialized().hashValue(
      this as CalendarFilter,
    );
  }
}
