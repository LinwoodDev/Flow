...
class EventFilterMapper extends ClassMapperBase<EventFilter> {
  ...
  static const Field<EventFilter, String> _f$source = Field(
    'source',
    _$source,
    opt: true,
  );
  static Uint8List? _$group(EventFilter v) => v.group;
  static const Field<EventFilter, Uint8List> _f$group = Field(
    'group',
    _$group,
    opt: true,
  );
  static Uint8List? _$resource(EventFilter v) => v.resource;
  static const Field<EventFilter, Uint8List> _f$resource = Field(
    'resource',
    _$resource,
    opt: true,
  );
...
mixin EventFilterMappable {
  String toJson() {
    return EventFilterMapper.ensureInitialized().encodeJson<EventFilter>(
      this as EventFilter,
    );
  }

  Map<String, dynamic> toMap() {
    return EventFilterMapper.ensureInitialized().encodeMap<EventFilter>(
      this as EventFilter,
    );
  }
  ...
  @override
  String toString() {
    return EventFilterMapper.ensureInitialized().stringifyValue(
      this as EventFilter,
    );
  }
  ...
  bool operator ==(Object other) {
    return EventFilterMapper.ensureInitialized().equalsValue(
      this as EventFilter,
      other,
    );
  }
