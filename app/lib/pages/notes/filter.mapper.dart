...
class NoteFilterMapper extends ClassMapperBase<NoteFilter> {
  ...
  static const Field<NoteFilter, bool> _f$showDone = Field(
    'showDone',
    _$showDone,
    opt: true,
    def: true,
  ...
  static const Field<NoteFilter, bool> _f$showInProgress = Field(
    'showInProgress',
    _$showInProgress,
    opt: true,
    def: true,
  ...
  static const Field<NoteFilter, bool> _f$showTodo = Field(
    'showTodo',
    _$showTodo,
    opt: true,
    def: true,
  ...
  static const Field<NoteFilter, bool> _f$showNote = Field(
    'showNote',
    _$showNote,
    opt: true,
    def: true,
  ...
  static const Field<NoteFilter, Uint8List> _f$selectedLabel = Field(
    'selectedLabel',
    _$selectedLabel,
    opt: true,
  );
  static Uint8List? _$notebook(NoteFilter v) => v.notebook;
  static const Field<NoteFilter, Uint8List> _f$notebook = Field(
    'notebook',
    _$notebook,
    opt: true,
  );
  static String? _$source(NoteFilter v) => v.source;
  static const Field<NoteFilter, String> _f$source = Field(
    'source',
    _$source,
    opt: true,
  );
...
mixin NoteFilterMappable {
  String toJson() {
    return NoteFilterMapper.ensureInitialized().encodeJson<NoteFilter>(
      this as NoteFilter,
    );
  }

  Map<String, dynamic> toMap() {
    return NoteFilterMapper.ensureInitialized().encodeMap<NoteFilter>(
      this as NoteFilter,
    );
  }
  ...
  @override
  String toString() {
    return NoteFilterMapper.ensureInitialized().stringifyValue(
      this as NoteFilter,
    );
  }
  ...
  bool operator ==(Object other) {
    return NoteFilterMapper.ensureInitialized().equalsValue(
      this as NoteFilter,
      other,
    );
  }
