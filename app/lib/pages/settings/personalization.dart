                          ...
                          children: [
                            ListTile(
                              ...
                              onTap: () async {
                                ...
                                final design = await showLeapBottomSheet<
                                        String>(
                                    context: context,
                                    titleBuilder: (ctx) => Text(
                            ...
                            ListTile(
                              ...
                              subtitle: Text(
                                  state.themeMode.getDisplayString(context)),
                              onTap: () async {
                                final cubit = context.read<SettingsCubit>();

                                final theme = await showLeapBottomSheet<
                                        ThemeMode>(
                                    context: context,
                                    titleBuilder: (ctx) => Text(
                                        AppLocalizations.of(context).theme),
                                    childrenBuilder: (context) => ThemeMode
                                        .values
                                        .map((e) => ListTile(
                                              title: Text(
                                                  e.getDisplayString(context)),
                            ...
                            ListTile(
                              ...
                              subtitle:
                                  Text(_getLocaleName(context, state.locale)),
                              onTap: () async {
                                final cubit = context.read<SettingsCubit>();

                                final locale =
                                    await showLeapBottomSheet<String>(
                                  context: context,
                                  titleBuilder: (ctx) => Text(
                            ...
                            if (!kIsWeb &&
                              ...
                              BlocBuilder<SettingsCubit, FlowSettings>(
                                  buildWhen: (previous, current) =>
                                      previous.nativeTitleBar !=
                                      current.nativeTitleBar,
