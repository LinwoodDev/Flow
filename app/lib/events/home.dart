...
class _EventsPageState extends State<EventsPage> {
  ...
  Widget build(BuildContext context) {
    return FlowScaffold(
        ...
        body: OpenContainer(
            openBuilder: (context, action) => EventPage(id: selected?.id),
            closedBuilder: (context, action) => LayoutBuilder(builder: (context, constraints) {
                  ...
                  return Row(
                      ...
                      children: [
                        if (isDesktop) ...[
                          Expanded(
                              flex: 2, child: EventPage(isDesktop: isDesktop, id: selected?.id)),
                          VerticalDivider()
                        ],
                        Expanded(
                            flex: 3,
