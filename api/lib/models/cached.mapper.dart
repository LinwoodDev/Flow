...
class CachedDataMapper extends ClassMapperBase<CachedData> {
  ...
  static const Field<CachedData, DateTime> _f$lastUpdated = Field(
    'lastUpdated',
    _$lastUpdated,
    opt: true,
  );
  static List<Event> _$events(CachedData v) => v.events;
  static const Field<CachedData, List<Event>> _f$events = Field(
    'events',
    _$events,
    opt: true,
    def: const [],
  ...
  static const Field<CachedData, List<Notebook>> _f$notebooks = Field(
    'notebooks',
    _$notebooks,
    opt: true,
    def: const [],
  ...
  static const Field<CachedData, List<CalendarItem>> _f$items = Field(
    'items',
    _$items,
    opt: true,
    def: const [],
  ...
  static const Field<CachedData, List<Note>> _f$notes = Field(
    'notes',
    _$notes,
    opt: true,
    def: const [],
...
mixin CachedDataMappable {
  String toJson() {
    return CachedDataMapper.ensureInitialized().encodeJson<CachedData>(
      this as CachedData,
    );
  }

  Map<String, dynamic> toMap() {
    return CachedDataMapper.ensureInitialized().encodeMap<CachedData>(
      this as CachedData,
    );
  }
  ...
  @override
  String toString() {
    return CachedDataMapper.ensureInitialized().stringifyValue(
      this as CachedData,
    );
  }
  ...
  bool operator ==(Object other) {
    return CachedDataMapper.ensureInitialized().equalsValue(
      this as CachedData,
      other,
    );
  }
