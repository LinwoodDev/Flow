...
olemaan paljastamatta tai käyttämättä tietoja mihinkään muuhun tarkoitukseen.
...
tai menetelmä elektronisen tallennustilan on 100% turvallinen ja luotettava, enkä voi taata sen ehdotonta turvallisuutta.
...
neuvoo tarkistamaan Tietosuojakäytäntö näiden verkkosivujen. Minulla ei ole mitään valtaa eikä ota vastuuta minkään kolmannen osapuolen sivustojen tai palvelujen sisällöstä, tietosuojakäytännöistä tai käytännöistä.
